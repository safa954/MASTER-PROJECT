...
<div id="myDiv">
  ...
  <form id="form" onsubmit="return validation()" method="post" name="regForm"  action="">
		...
		<input style=" height :45px ; width:100% ;border-radius: 5px; border:white " type="tel" name="mobile" size="25" placeholder="Your Phone" /><br><br>

		<div align="center">
		<input type="submit" value="Register" name="submit"   style="border-radius: 20px; background-color: #ab3c30;"/>
		<input type="reset" value="Clear" onclick="clear2();"   style="border-radius: 20px; background-color: #ab3c30;" /><br><br>
