        ...
        <div class="row no-gutters">
            <div class="col-md-8">
                <div class="product-details mr-2">
                    <a href="profile.php" class="btn btn-primary"style="border-radius: 20px; background-color: #ab3c30;">
                    ...
                    viweorder();
                    ?>
                    <h6><br> Total Of Order : <?php echo  $GLOBALS['row']['invoice'] ; ?> </h6>
                </div>
            </div>
            <div class="col-md-4">
