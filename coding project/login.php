...
<div id="myDiv" style="margin-top: 200px;">
  ...
  <form onsubmit="validation()" method="post" name="logform"  action="">
		...
		<div align="center">
		<input type="submit" value="Login" name="login" style="border-radius: 20px; background-color: #ab3c30;
"/>
        <a href="Register.php" style="font-size: medium; font-weight: 600; color:#dc3545 ;">or register now </a>
