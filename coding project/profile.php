                                    ...
                                    <div class="tab-content" id="myaccountContent">
                                        ...
                                        <div class="tab-pane fade <?php if(!isset($_GET['address'])){ echo 'active show'; }?>" id="dashboad" role="tabpanel">
                                            <div class="myaccount-content ">
                                                <h3>Dashboard</h3>
                                                <div class="welcome">
                                                    <p>Hello, <strong><?php echo $row['username']; ?></strong> (If Not <strong><?php echo $row['username']; ?> !</strong><a href="profile.php?logout=true" class="logout" style="color:#ab3c30"> Logout</a>)</p>
                                                </div>
...
<tbody>
    <tr>
      ...
      <td><?php echo '
      <a class="btn btn-primary" href="orderdetail.php?order_id='.$v['order_id'].'"  style="border-radius: 20px; background-color: #ab3c30;     width: 200px;">Show detaile </a>
  ...
  ?>
                                        ...
                                        <div class="tab-pane fade" id="payment-method" role="tabpanel">
                                            <div class="myaccount-content">
                                                ...
                                                <p class="saved-message" style="background-color: #fff;
    border-top: 3px solid #ab3c30;
    font-size: 14px;
    padding: 20px 0;
    color: #333;">You Can't Saved Your Payment Method yet. we just provid cash on delivery </p>
                                            </div>
                                        </div>
                                        <!-- Single Tab Content End -->
                                        <!-- Single Tab Content Start -->
                                        <div class="tab-pane fade <?php if(isset($_GET['address'])){ echo 'active show'; }?> " id="address-edit" role="tabpanel">
                                            <div class="myaccount-content">
                                                ...
                                                <?php if(isset($_GET['address'])){ 
                                                  ...
                                                  <input type="submit" id="display-name" value="Change Address" name="address"   style="border-radius: 20px; background-color: #ab3c30;     width: 200px;">
                                                  </form>
                                                  </div>
                                                  ';
                                                 }
                                                ...
                                                <a href="?address=true" class="check-btn sqr-btn " style="color:#ab3c30"><i class="fa fa-edit" style="color:#ab3c30"></i> Edit Address</a>
                                                <?php } ?>
                                              </div>
                                        </div>
                                        <!-- Single Tab Content End -->
                                            ...
                                            <div class="myaccount-content">
                                                ...
                                                <div class="account-details-form">
                                                    <form action="#">
                                                        ...
                                                        <div class="single-input-item">
                                                            <button class="check-btn sqr-btn "  style="border-radius: 20px; background-color: #ab3c30;     width: 200px;">Save Changes</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
