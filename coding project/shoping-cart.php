...
<body class="animsition">
	...
	';
									...
									<input type="submit" class="flex-c-m stext-101 cl2 size-118 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-5" name="update" value="Update Cart" style="border-radius: 20px; background-color: #ab3c30;">
