...
<?php require_once 'app/config/db.php';?>
 <?php 
    ...
    <div class="inside-banner">
        <div class="container">
            <!--<span class="pull-right"><a href="#">Home</a> / Track</span>-->
            <h2>Track</h2>
        </div>
    </div>
    <!-- banner -->
...
<?php foreach ($result as $row) {   ?>
  ...
  <div  class="col-lg-7  col-lg-offset-2 col-sm-12">
      <!-- agents -->
      <div   class="row">
         <div class="col-lg-2 col-sm-2 "><a href="#"><img src="image/track_transpornt.png" class="img-responsive"  alt="agent name"></a></div>
