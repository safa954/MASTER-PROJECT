...
<aside class="main-sidebar hidden-print ">
   <section class="sidebar" id="sidebar-scroll">
      ...
      <ul class="sidebar-menu">
          ...
          <li class="treeview">
              <a class="waves-effect waves-dark" href="gas.php">
              <i class="icofont icofont-university"></i><span> Gas Station</span>
              </a>                
          </li>

          <li class="treeview">
              <a class="waves-effect waves-dark" href="mechanic.php">
              <i class="icofont icofont-repair"></i><span> mechanic</span>
              </a>                
          </li>
          <li class="treeview">
              <a class="waves-effect waves-dark" href="users.php">
              <i class="icofont icofont-male"></i><span> Users</span>
              </a>                
          </li>
          <li class="treeview">
              <a class="waves-effect waves-dark" href="track.php">
              <i style="font-size:18px;" class="icofont icofont-concrete-mixer"></i><span> Transport Truck</span>
              </a>                
          </li>

          <li class="treeview">
              <a class="waves-effect waves-dark" href="contact_us.php">
                  <i style="font-size:18px;" class="icofont icofont-concrete-mixer"></i><span> Contact Us</span>
              </a>
          </li>
          <li class="treeview">
              <a class="waves-effect waves-dark" href="../logout.php">
                  <i style="font-size:18px;" class="icofont icofont-logout"></i><span> Logout</span>
